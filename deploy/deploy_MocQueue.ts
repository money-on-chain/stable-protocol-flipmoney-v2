...
const deployFunc: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  if (!pauserAddress) {
    ...
    console.log(`pauser address for MocFlipagoQueue set at deployer: ${pauserAddress}`);
  }
...
deployFunc.id = "deployed_MocFlipagoQueue"; // id required to prevent re-execution
deployFunc.tags = ["MocFlipagoQueue"];
