...
const deployFunc: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  if (!pauserAddress) {
    ...
    console.log(`pauser address for MocFlipagoVendors set at deployer: ${pauserAddress}`);
  }
  ...
  if (!governorAddress) {
    ...
    console.log(`using a governorMock for MocFlipagoVendors at: ${governorAddress}`);
  }
...
deployFunc.id = "deployed_MocFlipagoVendors"; // id required to prevent re-execution
deployFunc.tags = ["MocFlipagoVendors"];
